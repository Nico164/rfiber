...
import { useTestimonyData } from '../storage/useTestimonyData';
...
export default function UpdatePage() {
    ...
    const addTestimony = useTestimonyData(state => state.addTestimony)
    const ref = useRef();
    const [testimonyState, setTestimonyState] = useState({
        name: '',
        job: '',
        image: '',
        testimony: '',
    ...
    function onChange(event) {
        ...
        setTestimonyState({ ...testimonyState, [name]: value });
    }

    function onSubmit(event) {
        event.preventDefault();
        addTestimony(testimonyState);
        setTestimonyState({
            name: '',
            job: '',
            testimony: '',
                                ...
                                <VStack spacing={5}>
                                    ...
                                    <FormControl isRequired>
                                        ...
                                        <Textarea
                                            ...
                                            resize="none"
                                            onChange={onChange}
                                            value={testimonyState.testimony}
                                        />
                                    </FormControl>
